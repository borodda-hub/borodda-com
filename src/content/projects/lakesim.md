...
The prototype was profiled in [The New York Times](https://www.nytimes.com), [Next City](https://nextcity.org/daily/entry/chicago-lakesim-scientists-developers-urban-design), Curbed Chicago, and Geospatial World, and the work was published in the 2015 [ISOCARP Review 11: Reinventing Planning](https://isocarp.org/review/) (Bergerson, Muehleisen, Rodda, Guzowski, Ozik, Auld, & Collier, 2015). The Chicago Lakeside Development itself underwent significant changes in the years following — a reminder that simulation is not prophecy, and that the most useful urban modeling tools are the ones that help us think clearly about possibility, not the ones that promise certainty.
